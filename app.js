...
app.get("/", function(req, res) {
  Post.find({}, function(err, foundPost) {
    if(!err) {
      res.render("home", {homeContent: homeStartingContent, jPost: foundPost});
    }
  });
});
...
app.post("/compose", function(req, res) {
  const newpost = new Post ({
    title: lodash.capitalize(req.body.journalTitle),
...
app.get("/posts/:postTitle", function(req, res) {
  let posttitle = lodash.capitalize(req.params.postTitle);
  Post.findOne({title: posttitle}, function (err, foundPost) {
      console.log("Found the Post" + foundPost.title);
